...
public class EmpresasController {
    ...
    public ResponseEntity<EmpresasEntity> updatingRegistro(@PathVariable("id") Long idEmpresa, @RequestBody EmpresasEntity cEmpresa){
        ...
        if(empresasData.isPresent()){
            ...
            empresas.setId(cEmpresa.getId());
            empresas.setNombre(cEmpresa.getNombre());
            empresas.setSatRegimen(cEmpresa.getSatRegimen());
            empresas.setCp(cEmpresa.getCp());
            empresas.setCerB64(cEmpresa.getCerB64());
            empresas.setKeyB64(cEmpresa.getKeyB64());
